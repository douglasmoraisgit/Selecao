 ...
 * 
 * CORREÇÃO: Agora estende LenteODeOE para fazer parte da hierarquia Produto
 * 
 * Hierarquia:
 *   Produto (abstract)
 *      └── Lente
 *            └── LenteODeOE
 *                  └── LenteComTratamento  ← AQUI!
 * 
 * Usado quando:
 ...
 * @author OptoFreela
 */
public class LenteComTratamento2 extends LenteODeOE {

    // ========================================
    // CAMPOS PARA TRATAMENTO ADICIONAL
    // (campos básicos da lente são HERDADOS de LenteODeOE/Lente)
    // ========================================
    ...
    public LenteComTratamento2(LenteODeOE lente) {
        ...
        // Copiar todos os campos de LenteODeOE/Lente
        this.setIdLente(lente.getIdLente());
        this.setChave(lente.getChave() != null ? lente.getChave() : 0L);
        ...
        this.setTipoOlho(lente.getTipoOlho());
    ...
    /**
     * Construtor a partir de Lente genérica
     */
    public LenteComTratamento2(Lente lente) {
        super();
     ...
     * CORREÇÃO: Método que estava faltando e era chamado em CarrinhoDistinto
     */
