...
export default class SearchController extends EventEmitter {
     ...
     * - Salva uma receita
     * @param {Object} filtrosExtras - Filtros adicionais opcionais (ex: { permite_colorir: 'Sim' })
     */
    buscarComFiltrosAtuais(filtrosExtras = null) {
        // Armazena filtros extras para uso em executarBusca
    ...
    montarPayloadCompleto(receita) {
        ...
        // ========================================
        // 6. FILTROS EXTRAS (temporários, ex: permite_colorir)
        // ========================================
        if (this.filtrosExtras) {
            console.log('   🔧 Filtros extras:');
            Object.entries(this.filtrosExtras).forEach(([key, value]) => {
                params.append(key, value);
                console.log(`      - ${key}: ${value}`);
            });
            // Limpa filtros extras após uso
