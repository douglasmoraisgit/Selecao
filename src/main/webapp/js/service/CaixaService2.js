...
export class CaixaService {
    ...
    async aprovarPagamento(idPedido, idFormaPagamento, numeroAutorizacao = null) {
        try {
            ...
            const response = await fetch('AprovarPagamentosIndividual', {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorText || 'Erro ao aprovar pagamento');
            }
