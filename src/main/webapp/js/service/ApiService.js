...
export default class ApiService {
    ...
    /**
     * Busca tratamentos compatíveis com família ou famílias compatíveis com tratamento
     * @param {Object} params - { familia } ou { tratamento }
     * @returns {Promise<Object>} - { tratamentos: [...] } ou { familias: [...] }
     */
    ...
    /**
     * NOVO: Verifica se família/marca permite coloração
     * @param {Object} params - { familia } ou { marca }
     * @returns {Promise<Object>} - { permiteColorir: true/false, familias: [...] }
     */
    async verificaColoracao(params) {
        return this.get('/VerificaColoracao', params);
    }
}
