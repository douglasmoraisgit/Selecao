...
export default class ReceitaView extends EventEmitter {
    ...
    createButton() {
        ...
        if (!this.btnReceita) {
            ...
            this.btnReceita.className = 'toolbar__btn toolbar__btn--alerta';
            this.btnReceita.innerHTML = `
                <span class="toolbar__btn-icon">📋</span>
                <span class="toolbar__btn-text">Sem Receita</span>
            `;
    ...
    atualizarBotao(temReceita, resumo = null) {
        ...
        this.btnReceita.classList.remove(
            'toolbar__btn--alerta',
            'toolbar__btn--ok',
            ...
            'toolbar__btn--active',
            'toolbar__btn--receita'
        );
        
        // Mantém classe base
        this.btnReceita.classList.add('toolbar__btn');
        
        // Busca elementos internos
        const iconEl = this.btnReceita.querySelector('.toolbar__btn-icon');
        const textEl = this.btnReceita.querySelector('.toolbar__btn-text');
        
        if (temReceita && resumo) {
            this.btnReceita.classList.add('toolbar__btn--ok');
            if (iconEl) iconEl.textContent = '📋';
            if (textEl) textEl.textContent = 'Com Receita';
            this.btnReceita.title = `OD: ${resumo.od}\nOE: ${resumo.oe}`;
        } else {
            this.btnReceita.classList.add('toolbar__btn--alerta');
            if (iconEl) iconEl.textContent = '📋';
